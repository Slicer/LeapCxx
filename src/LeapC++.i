...
// Leap::Config::Value::operator= causes this warning
...
%constattrib( Leap::Finger, int, id );
%leapattrib( Leap::Finger, Vector, tipPosition );
%leapattrib( Leap::Finger, Vector, direction );
%constattrib( Leap::Finger, Leap::Finger::Type, type );
%constattrib( Leap::Finger, float, width );
%constattrib( Leap::Finger, float, length );
%constattrib( Leap::Finger, bool, isExtended );
%constattrib( Leap::Finger, float, timeVisible );
%constattrib( Leap::Finger, bool, isValid );
